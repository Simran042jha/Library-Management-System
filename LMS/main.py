...
class main:
    def login(self):
        ...
        if self.ab!=None:
            ...
            self.ig=PhotoImage(file='./static/nhce.png')
    ...
    def cur(self):
        ...
        self.photo9=PhotoImage(file="./static/library.png")
        self.canvas8.create_image(0,0,image=self.photo9,anchor=NW)
        
        self.develop=Label(self.fm3,text='Developed By - Simran',bg='#fff',fg='#d7837f',font=('Candara',12,'bold'))
        ...
        self.logo = PhotoImage(file='./static/bt1.png')
        ...
        self.log = PhotoImage(file='./static/bt2.png')
        ...
        self.logb = PhotoImage(file='./static/bt3.png')
        ...
        self.log4 = PhotoImage(file='./static/bt4.png')
        ...
        self.log5 = PhotoImage(file='./static/bt5.png')
        ...
        self.log6 = PhotoImage(file='./static/bt6.png')
        ...
        self.log7 = PhotoImage(file='./static/bt7.png')
        ...
        try:
            ...
            self.log8 = PhotoImage(file='./static/bt8.png')
            ...
            self.log9 = PhotoImage(file='./static/bt8.png')
    ...
    def addbook(self):
        class temp(main):
            def book(self):
                ...
                self.log = PhotoImage(file='./static/backbtn1.png')
            ...
            def data(self):
                ...
                if self.value!=None:
                    if(self.flag!=1):
                        ...
                        self.boot.iconbitmap("./static/aa.ico")
        ...
        class editing(main):
            ...
            def searchedit(self):
                ...
                if self.val!=None:
                    ...
                    self.edcat.iconbitmap("./static/aa.ico")
    ...
    def returnbook(self):
        class retu(main):
            def __init__(self):
                ...
                self.button10 = Button(self.f1, text="SHOW BOOKS",bg='#581845', fg='#fff', width=12, height=0,
                                    font=('Calibri', 12, 'bold'),command=self.showIssuedBooks,activebackground="#000",activeforeground="#581845" )
                self.button10.place(x=250, y=120)
            ...
            def showIssuedBooks(self):
                self.tom=Tk()
                self.tom.geometry("600x300")
                self.tom.iconbitmap("./static/aa.ico")
                self.tom.title("Library System")
                self.tom.resizable(0,0)
                self.tom.configure(bg="#ffe8ec")
                self.table_frame=Frame(self.tom,bg='#ffe8ec',bd=1,relief='flat')
                self.table_frame.place(x=20,y=20,width=580,height=280)
                
                self.scroll_x=Scrollbar(self.table_frame,orient=HORIZONTAL)
                self.scroll_y=Scrollbar(self.table_frame,orient=VERTICAL)
                self.book_table=ttk.Treeview(self.table_frame,columns=("Name", "FromDate", "ToDate", "Title", "Author"),xscrollcommand=self.scroll_x.set,yscrollcommand=self.scroll_y.set)
                ...
                self.book_table.heading("FromDate", text="FromDate")
                self.book_table.heading("ToDate", text="ToDate")
                self.book_table['show']='headings'
                self.book_table.column("Name",width=50)
                self.book_table.column("Title", width=50)
                self.book_table.column("Author", width=50)
                self.book_table.column("FromDate", width=50)
                self.book_table.column("ToDate", width=50)
            ...
            def getData(self):
                ...
                cursor=dbstudents.cursor()
                cursor.execute("SELECT Name,FromDate, ToDate FROM Students Where ERP='"+self.entry+"'")
                self.issuedTo=cursor.fetchall()
                cursor.close()
                cursor = dbstore.cursor()
                cursor.execute("SELECT Title, Author FROM Books Where ID='"+self.entry+"'")
                self.book=cursor.fetchall()
                cursor.close()
                if len(self.book)!=0:
                        for self.row in self.book:
                                self.book_table.insert('',END,values=self.issuedTo[0]+self.row)
                dbstore.commit()
            def retbook(self):
                self.charge=0
                self.entry=self.entry4.get()
        ...
        class demt(main):
            ...
            def srch(self):
                ...
                if self.srval!=None:
                    ...
                    self.top.iconbitmap("./static/aa.ico")
    ...
    def code(self):
            ...
            self.photo=PhotoImage(file=r"libraryBG.png")
            ...
            self.logo = PhotoImage(file=r"./static/bt1.png")
            ...
            self.log = PhotoImage(file=r"./static/bt2.png")
    ...
    def mouseClick(self,event):
        ...
        self.rog.iconbitmap("./static/aa.ico")
